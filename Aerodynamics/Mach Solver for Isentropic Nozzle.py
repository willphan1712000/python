...
class GUI_ThanhNha:
    def __init__(self, root):
        self.root = root
        self.root.title('MACH SOLVING FOR NOZZLE')
        self.root.geometry('360x350')

        # Area Ratio
        Ratio_text = StringVar()
        Ratio_label = Label(root, text = 'Area Ratio', font = ('bold',14), pady =20)
        ...
        #Initial Mach value
        Ini_text = StringVar()
        Ini_label = Label(root, text = 'Initial Mach', font = ('bold',14), pady =20)
